...
class UserActions(Generic[_PrismaModelT]):
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group User records by phoneVerified values
...
class EnrollmentActions(Generic[_PrismaModelT]):
    ...
    async def find_many(
        ...
        # find the first 5 Enrollment records ordered by the moduleId field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Enrollment record ordered by the pathId field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Enrollment record ordered by the startedAt field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Enrollment records by updatedAt values
        # and count how many records are in each group
...
class ProjectActions(Generic[_PrismaModelT]):
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Project record ordered by the ownerId field
...
class DatasetActions(Generic[_PrismaModelT]):
    ...
    async def query_first(
        ...
        *args
        ...
        user = await Dataset.prisma().query_first(
            'SELECT * FROM Dataset WHERE name = $1',
            'beicihhijb',
        )
        ```
        """
            ...
            data=[
                {
                    ...
                    'name': 'ebajedhhf',
                    'slug': 'jajacedge',
                    'sourceType': 'hffgbabgf',
                },
                {
                    # data to create a Dataset record
                    'name': 'biacbiieja',
                    'slug': 'cjejbgbff',
                    'sourceType': 'fgeahddae',
                },
            ],
            skip_duplicates=True,
        )
    ...
    async def find_many(
        ...
        # find the first 5 Dataset records ordered by the slug field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Dataset record ordered by the userId field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Dataset records by filePath values
        # and count how many records are in each group
...
class DashboardActions(Generic[_PrismaModelT]):
    ...
    async def find_many(
        ...
        # find the first 5 Dashboard records ordered by the slug field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Dashboard record ordered by the description field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Dashboard record ordered by the ownerId field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Dashboard records by deletedAt values
        # and count how many records are in each group
    ...
    async def create(
        ...
        dashboarddataset = await DashboardDataset.prisma().create(
            data={
                ...
                'dashboardId': 1719240611,
                'datasetId': 1948555936,
            },
        )
        ```
        """
        ...
        *,
        ...
        total = await DashboardDataset.prisma().create_many(
            data=[
                {
                    # data to create a DashboardDataset record
                    'dashboardId': 1383253593,
                    'datasetId': 354664990,
                },
                {
                    # data to create a DashboardDataset record
                    'dashboardId': 647166719,
                    'datasetId': 357089484,
                },
            ],
            skip_duplicates=True,
            ...
            data=[
                {
                    # data to create a Widget record
                    'type': enums.WidgetType.CHART,
                    'config': Json({'bbhcgagaic': True}),
                },
                {
                    # data to create a Widget record
                    'type': enums.WidgetType.CHART,
                    'config': Json({'ddaabegbb': True}),
                },
            ],
            skip_duplicates=True,
        )
        ...
        *,
        ...
        total = await Insight.prisma().create_many(
            data=[
                {
                    # data to create a Insight record
                    'dashboardId': 850004390,
                    'content': 'cbajdjjabf',
                },
                {
                    # data to create a Insight record
                    'dashboardId': 1282664340,
                    'content': 'cebcdadjh',
                },
            ],
            skip_duplicates=True,
        ...
        *,
        ...
        total = await Transaction.prisma().create_many(
            data=[
                {
                    # data to create a Transaction record
                    'amountCents': 644446024,
                    'type': 'bbgdigchd',
                },
                {
                    # data to create a Transaction record
                    'amountCents': 309285638,
                    'type': 'ccedhdbj',
                },
            ],
            skip_duplicates=True,
